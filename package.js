...
Package.onUse(function(api) {
  ...
  api.use('aldeed:autoform@5.1.2', 'client');
  ...
  api.addFiles([
    ...
    'templates/semantic-ui/inputTypes/select-icons-search/select-icons-search.html',
    'templates/semantic-ui/inputTypes/select-icons-search/select-icons-search.js',
