AutoForm.addInputType("select-search", {
  template: "afSelectSearch",
  valueOut: function () {
    return this.val();
  },
  valueConverters: {
...
Template.afSelectSearch_semanticUI.helpers({
  atts: function selectAttsAdjust() {
    var atts = _.clone(this.atts);

    // Add semantic-ui class
    atts = AutoForm.Utility.addClass(atts, "ui search dropdown");

    return atts;
  }
});

Template.afSelectSearch_semanticUI.onRendered(function() {
